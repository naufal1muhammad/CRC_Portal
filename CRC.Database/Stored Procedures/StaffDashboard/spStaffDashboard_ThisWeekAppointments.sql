CREATE PROCEDURE [dbo].[spStaffDashboard_ThisWeekAppointments]
(
...
BEGIN
    ...
    DECLARE @EndDate   DATE = DATEADD(DAY, 7, @StartDate); -- rolling next 7 days (start inclusive, end exclusive)
